...
import { FaUserCircle, FaUserTie, FaRegBuilding, FaEnvelope, FaPhone, FaLinkedin } from "react-icons/fa";
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mt-6">
        ...
        <p className="text-gray-700 text-lg">Department: {employee.department}</p>
        <p className="text-gray-700 text-lg">Employment Date: {employee.employment_date}</p>
        <p className="text-gray-700 text-lg">Date of Birth: {employee.date_of_birth}</p>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mt-6">
        ...
        <p className="text-gray-700 text-lg">Experience details...will be added by HR soon</p>
      </div>
      ...
      <div className="bg-white shadow-lg rounded-lg p-6 mt-6">
        ...
        <p className="text-gray-700 text-lg">Alternate Phone: {employee.alternate_phone || "N/A"}</p>
        <p className="text-gray-700 text-lg">Emergency Contact: {employee.emergency_contact || "N/A"}</p>
